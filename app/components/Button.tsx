...
export default function Button({onClick, children}: ButtonProps) {
    return <button className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 
    ...
    dark:focus:ring-gray-700" onClick={() => onClick()}>{children}</button>
}
